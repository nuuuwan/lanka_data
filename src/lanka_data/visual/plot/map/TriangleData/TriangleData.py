...
from lanka_data.visual.plot.map.TriangleData.TriangleDataAssignMixin import (
    TriangleDataAssignMixin,
)
...
class TriangleData(
    ...
    def _value_per_triangle_range(region_to_weight, triangles):
        region_to_count = {}
        for region_id, _, _, _ in triangles:
    ...
    def _compute(cls, data_list, region_to_weight):
        ...
        triangles = cls.assign(centroids, counts, centers)
