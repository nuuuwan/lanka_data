class LabelTruncator:
    ...
    MAX_REGIONS_TRUNCATE_MID = 60
    MAX_REGIONS_TRUNCATE_SMALL = 500

    HEX_MAX_REGIONS_FULL_LABEL = 30
    HEX_MAX_REGIONS_TRUNCATE_MID = 60
    HEX_MAX_REGIONS_TRUNCATE_SMALL = 500
