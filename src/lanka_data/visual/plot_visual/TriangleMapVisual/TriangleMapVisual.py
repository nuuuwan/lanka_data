...
from lanka_data.visual.plot_visual.TriangleMapVisual.TriangleMapDrawMixin \
    import TriangleMapDrawMixin
from lanka_data.visual.plot_visual.TriangleMapVisual.TriangleMapLabelMixin \
    import TriangleMapLabelMixin
