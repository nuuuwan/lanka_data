...
from lanka_data.visual.plot_visual.TriangleMapVisual.TriangleMapLabelFitMixin \
    import TriangleMapLabelFitMixin
from lanka_data.visual.plot_visual.TriangleMapVisual.TriangleMapLabelGeoMixin \
    import TriangleMapLabelGeoMixin
from utils_future import ColorUtils, timer


class TriangleMapLabelMixin(
    TriangleMapLabelGeoMixin, TriangleMapLabelFitMixin
):
