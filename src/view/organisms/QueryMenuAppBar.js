...
import QueryHistoryMenu from "../moles/QueryHistoryMenu.js";
import RepositoryLinksMenu from "../moles/RepositoryLinksMenu.js";
...
export default function QueryMenuAppBar({ loadedVisualQuery }) {
  ...
  const [recentQueries, setRecentQueries] = useState(RecentVisualQueries.read);
