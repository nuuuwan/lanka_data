...
**Example — single region with breakdown:**
...
// /Gender/2024/LK
{
  ...
  "total_value": 21781800,
  "n_values": 2,
  "values": { "female": 11269456, "male": 10512344 },
  "p_values": { "female": 51.74, "male": 48.26 }
}
```

**Example — sub-region breakdown (`total_value` and `values` keyed by region):**
...
// /Election:Presidential/2024/LK
{
  ...
  "total_value": 13319616,
  "n_values": 38,
  "party": { "NPP": 5634915, "SJB": 4363035, "IND16": 2299767, ... },
  "p_party": { "NPP": 42.31, "SJB": 32.76, "IND16": 17.27, ... }
}
```
...
// /*/2024/LK
{
  ...
  "total_value": null,
  "n_values": null,
  "values": { "measurements": ["AgeGroup", "Ethnicity", "Gender", ...] },
  "p_values": null
}
```
